...
export const learningTracks: LearningTrack[] = [
  {
    ...
    lessonSlugs: ['arrays-hash-maps'], representativeProblemIds: [1, 121], entryProblemId: 1, prerequisiteTrackIds: [],
  },
  {
    id: 'strings', title: 'Strings', description: 'Character sequences, windows, and direct scans.', icon: 'mdi-format-text',
    lessonSlugs: ['sliding-window'], representativeProblemIds: [3, 28], entryProblemId: 3, prerequisiteTrackIds: ['arrays'],
  },
  {
    id: 'hash-maps', title: 'Hash Maps', description: 'Keyed lookup, membership, frequencies, and complements.', icon: 'mdi-table-key',
    lessonSlugs: ['arrays-hash-maps'], representativeProblemIds: [1], entryProblemId: 1, prerequisiteTrackIds: ['arrays'],
  },
  {
    id: 'linked-lists', title: 'Linked Lists', description: 'Node references, rewiring, and pointer roles.', icon: 'mdi-link-variant',
    lessonSlugs: ['linked-lists'], representativeProblemIds: [206, 141], entryProblemId: 206, prerequisiteTrackIds: [],
  },
  {
    id: 'trees', title: 'Trees', description: 'Hierarchy, traversal, recursion, and search invariants.', icon: 'mdi-file-tree-outline',
    lessonSlugs: ['trees'], representativeProblemIds: [104, 102], entryProblemId: 104, prerequisiteTrackIds: ['arrays'],
  },
  {
    id: 'graphs', title: 'Graphs', description: 'Relationships, traversal, reachability, and dependencies.', icon: 'mdi-graph-outline',
    lessonSlugs: ['graphs', 'graph-traversal'], representativeProblemIds: [207, 261], entryProblemId: 207, prerequisiteTrackIds: ['trees'],
  },
  {
    ...
    lessonSlugs: ['dynamic-programming'], representativeProblemIds: [70, 139], entryProblemId: 70, prerequisiteTrackIds: ['arrays'],
  },
  {
    id: 'heaps', title: 'Heaps', description: 'Priority-based access to the next most important item.', icon: 'mdi-triangle-outline',
    lessonSlugs: ['heaps'], representativeProblemIds: [215, 23], entryProblemId: 215, prerequisiteTrackIds: ['arrays'],
  },
]
